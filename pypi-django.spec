...
Version  : 5.1.5
Release  : 45
URL      : https://files.pythonhosted.org/packages/e4/17/834e3e08d590dcc27d4cc3c5cd4e2fb757b7a92bab9de8ee402455732952/Django-5.1.5.tar.gz
Source0  : https://files.pythonhosted.org/packages/e4/17/834e3e08d590dcc27d4cc3c5cd4e2fb757b7a92bab9de8ee402455732952/Django-5.1.5.tar.gz
...
%prep
%setup -q -n Django-5.1.5
cd %{_builddir}/Django-5.1.5
pushd ..
cp -a Django-5.1.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736866487
