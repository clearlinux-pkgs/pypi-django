...
Version  : 5.0.1
Release  : 31
URL      : https://files.pythonhosted.org/packages/53/82/c8e8ed137da1c72fa110e3be9ab0f26bcfcf6f3d2994601d164dfac86269/Django-5.0.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/53/82/c8e8ed137da1c72fa110e3be9ab0f26bcfcf6f3d2994601d164dfac86269/Django-5.0.1.tar.gz
...
%prep
%setup -q -n Django-5.0.1
cd %{_builddir}/Django-5.0.1
pushd ..
cp -a Django-5.0.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1704209965
