...
Version  : 5.0.7
Release  : 37
URL      : https://files.pythonhosted.org/packages/6d/cc/5384bf3daa6c857ccb731388bd59d15932157953c1ea05ebccc7591af492/Django-5.0.7.tar.gz
Source0  : https://files.pythonhosted.org/packages/6d/cc/5384bf3daa6c857ccb731388bd59d15932157953c1ea05ebccc7591af492/Django-5.0.7.tar.gz
...
%prep
%setup -q -n Django-5.0.7
cd %{_builddir}/Django-5.0.7
pushd ..
cp -a Django-5.0.7 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720642287
