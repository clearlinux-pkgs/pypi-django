...
Source0  : https://files.pythonhosted.org/packages/e1/b1/ac6a16aaf0049637b50afbcf06b8ec2fa5c6ce42d4ae6ba66bbaf4c3609a/Django-5.0.3.tar.gz
...
%prep
%setup -q -n Django-5.0.3
cd %{_builddir}/Django-5.0.3
pushd ..
cp -a Django-5.0.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709568272
