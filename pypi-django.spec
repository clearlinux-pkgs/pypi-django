...
Version  : 5.1.4
Release  : 44
URL      : https://files.pythonhosted.org/packages/d3/e8/536555596dbb79f6e77418aeb40bdc1758c26725aba31919ba449e6d5e6a/Django-5.1.4.tar.gz
Source0  : https://files.pythonhosted.org/packages/d3/e8/536555596dbb79f6e77418aeb40bdc1758c26725aba31919ba449e6d5e6a/Django-5.1.4.tar.gz
...
%prep
%setup -q -n Django-5.1.4
cd %{_builddir}/Django-5.1.4
pushd ..
cp -a Django-5.1.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1733397040
