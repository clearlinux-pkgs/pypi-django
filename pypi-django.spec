...
Source0  : https://files.pythonhosted.org/packages/9c/e5/a06e20c963b280af4aa9432bc694fbdeb1c8df9e28c2ffd5fbb71c4b1bec/Django-5.1.2.tar.gz
...
%prep
%setup -q -n Django-5.1.2
cd %{_builddir}/Django-5.1.2
pushd ..
cp -a Django-5.1.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1728421941
