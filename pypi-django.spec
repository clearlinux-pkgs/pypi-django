...
Version  : 5.1.3
Release  : 43
URL      : https://files.pythonhosted.org/packages/c6/85/ba2c2b83ba8b95354f99ed8344405d9571109ce0175028876209d6b93fba/Django-5.1.3.tar.gz
Source0  : https://files.pythonhosted.org/packages/c6/85/ba2c2b83ba8b95354f99ed8344405d9571109ce0175028876209d6b93fba/Django-5.1.3.tar.gz
...
%prep
%setup -q -n Django-5.1.3
cd %{_builddir}/Django-5.1.3
pushd ..
cp -a Django-5.1.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1730822134
