...
Source0  : https://files.pythonhosted.org/packages/50/98/499a2d11eb0b22fdd55ce5895e0f5ce6d7d4957a785f237a89317cb478fa/Django-5.0.2.tar.gz
...
%prep
%setup -q -n Django-5.0.2
cd %{_builddir}/Django-5.0.2
pushd ..
cp -a Django-5.0.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707259732
