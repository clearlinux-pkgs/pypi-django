...
Version  : 5.1.1
Release  : 40
URL      : https://files.pythonhosted.org/packages/88/6f/8f57ed6dc88656edd4fcb35c50dd963f3cd79303bd711fb0160fc7fd6ab7/Django-5.1.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/88/6f/8f57ed6dc88656edd4fcb35c50dd963f3cd79303bd711fb0160fc7fd6ab7/Django-5.1.1.tar.gz
...
%prep
%setup -q -n Django-5.1.1
cd %{_builddir}/Django-5.1.1
pushd ..
cp -a Django-5.1.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1725395056
